...
function showSlides(n) {
    ...
    // Ensure that the current slide is visible
    for (let i = 0; i < slides.length; i++) {
        slides[i].style.display = "none"; // Hide all slides
    }

    slides[n - 1].style.display = "block"; // Display the selected slide

    // Manage dot active class
